...
DECLARE @Nombres NVARCHAR(100) = CASE (@Semilla % 300)
                                     ...
                                     WHEN 9 THEN CASE @Genero WHEN 'M' THEN 'Miguel Ángel' ELSE 'Isabella Catalina' END
                                     WHEN 10 THEN CASE @Genero WHEN 'M' THEN 'José Luis' ELSE 'Laura Vanessa' END
                                     WHEN 11 THEN CASE @Genero WHEN 'M' THEN 'Diego Armando' ELSE 'Camila Alejandra' END
                                     WHEN 12 THEN CASE @Genero WHEN 'M' THEN 'Alejandro José' ELSE 'Sofía Elizabeth' END
                                     WHEN 13 THEN CASE @Genero WHEN 'M' THEN 'Ricardo Martín' ELSE 'Valeria Marisol' END
                                     WHEN 14 THEN CASE @Genero WHEN 'M' THEN 'Eduardo Martín' ELSE 'Natalia Beatriz' END
                                     WHEN 15 THEN CASE @Genero WHEN 'M' THEN 'Manuel Jesús' ELSE 'Carolina Isabel' END
                                     WHEN 16
                                     ...
                                     WHEN 18 THEN CASE @Genero WHEN 'M' THEN 'Raúl Ernesto' ELSE 'Adriana Lucía' END
                                     WHEN 19 THEN CASE @Genero WHEN 'M' THEN 'Víctor Manuel' ELSE 'Mariana Fernanda' END
                                     WHEN 20 THEN CASE @Genero WHEN 'M' THEN 'Ángel David' ELSE 'Nicole Stefany' END
                                     WHEN 21
                                         THEN CASE @Genero WHEN 'M' THEN 'Marco Antonio' ELSE 'Fiorella Geraldine' END
                                     WHEN 22 THEN CASE @Genero WHEN 'M' THEN 'Javier Alonso' ELSE 'Lesly Giuliana' END
                                     WHEN 23
                                     ...
                                     WHEN 25 THEN CASE @Genero WHEN 'M' THEN 'Jean Pierre' ELSE 'Ximena del Pilar' END
                                     WHEN 26
                                         THEN CASE @Genero WHEN 'M' THEN 'Bryan Stiven' ELSE 'Milagros del Rosario' END
                                     WHEN 27 THEN CASE @Genero WHEN 'M' THEN 'Jhonatan Paul' ELSE 'Fátima del Rocío' END
                                     WHEN 28
                                     ...
                                     WHEN 32 THEN CASE @Genero WHEN 'M' THEN 'Julio César' ELSE 'Rosa Elena' END
                                     WHEN 33 THEN CASE @Genero WHEN 'M' THEN 'Héctor Raúl' ELSE 'Gloria Mercedes' END
                                     WHEN 34
                                     ...
                                     WHEN 36 THEN CASE @Genero WHEN 'M' THEN 'Rodolfo Antonio' ELSE 'Clara Inés' END
                                     WHEN 37 THEN CASE @Genero WHEN 'M' THEN 'Walter Eduardo' ELSE 'Silvia Roxana' END
                                     WHEN 38 THEN CASE @Genero WHEN 'M' THEN 'Alfredo José' ELSE 'Mónica Liliana' END
                                     WHEN 39
                                     ...
                                     WHEN 41 THEN CASE @Genero WHEN 'M' THEN 'Santiago Martín' ELSE 'Jimena Valeria' END
                                     WHEN 42 THEN CASE @Genero WHEN 'M' THEN 'Mateo Alejandro' ELSE 'Renata Sofía' END
                                     WHEN 43 THEN CASE @Genero WHEN 'M' THEN 'Thiago Nicolás' ELSE 'Emma Valentina' END
                                     WHEN 44 THEN CASE @Genero WHEN 'M' THEN 'Liam Santiago' ELSE 'Zoe Victoria' END
                                     WHEN 45 THEN CASE @Genero WHEN 'M' THEN 'Dylan Fabricio' ELSE 'Luna Catalina' END
                                     WHEN 46 THEN CASE @Genero WHEN 'M' THEN 'Gael Mauricio' ELSE 'Mía Alessandra' END
                                     WHEN 47 THEN CASE @Genero WHEN 'M' THEN 'Ian Sebastián' ELSE 'Amelia Isabella' END
                                     WHEN 48 THEN CASE @Genero WHEN 'M' THEN 'Noah Benjamín' ELSE 'Olivia Regina' END
                                     WHEN 49 THEN CASE @Genero WHEN 'M' THEN 'Lucas Matías' ELSE 'Aurora Celeste' END

                                     WHEN 50
                                         THEN CASE @Genero WHEN 'M' THEN 'Benjamín Alonso' ELSE 'Emilia Guadalupe' END
                                     WHEN 51 THEN CASE @Genero WHEN 'M' THEN 'Emilio Andrés' ELSE 'Valentina Paz' END
                                     WHEN 52 THEN CASE @Genero WHEN 'M' THEN 'Tomás Ignacio' ELSE 'Martina Belén' END
                                     WHEN 53 THEN CASE @Genero WHEN 'M' THEN 'Joaquín Mateo' ELSE 'Isabella Renata' END
                                     WHEN 54 THEN CASE @Genero WHEN 'M' THEN 'Agustín Gabriel' ELSE 'Catalina Sofía' END
                                     WHEN 55
                                     ...
                                     WHEN 57 THEN CASE @Genero WHEN 'M' THEN 'Facundo Alexis' ELSE 'Luciana Abigail' END
                                     WHEN 58
                                         THEN CASE @Genero WHEN 'M' THEN 'Bruno Ezequiel' ELSE 'Delfina Milagros' END
                                     WHEN 59 THEN CASE @Genero WHEN 'M' THEN 'Valentín Hugo' ELSE 'Morena Elizabeth' END
                                     WHEN 60 THEN CASE @Genero WHEN 'M' THEN 'René Alberto' ELSE 'Yomira del Pilar' END
                                     WHEN 61 THEN CASE @Genero WHEN 'M' THEN 'Percy William' ELSE 'Yadira Marisol' END
                                     WHEN 62
                                     ...
                                     WHEN 65 THEN CASE @Genero WHEN 'M' THEN 'Pool Junior' ELSE 'Kiara Valentina' END
                                     WHEN 66 THEN CASE @Genero WHEN 'M' THEN 'Jerson Miguel' ELSE 'Naomi Scarlett' END
                                     WHEN 67 THEN CASE @Genero WHEN 'M' THEN 'Deyvis Jesús' ELSE 'Luana Fernanda' END
                                     WHEN 68 THEN CASE @Genero WHEN 'M' THEN 'Yeferson Staly' ELSE 'Ashley Nicol' END
                                     WHEN 69 THEN CASE @Genero WHEN 'M' THEN 'Cruz Ángel' ELSE 'Fabiola del Rosario' END
                                     WHEN 70 THEN CASE @Genero WHEN 'M' THEN 'Wilson Omar' ELSE 'María Pía' END
                                     WHEN 71 THEN CASE @Genero WHEN 'M' THEN 'Rony Alexander' ELSE 'María José' END
                                     WHEN 72 THEN CASE @Genero WHEN 'M' THEN 'Joel David' ELSE 'María Fe' END
                                     WHEN 73
                                         THEN CASE @Genero WHEN 'M' THEN 'Yober Alejandro' ELSE 'María Auxiliadora' END
                                     WHEN 74 THEN CASE @Genero WHEN 'M' THEN 'Javier Eduardo' ELSE 'Rosa María' END
                                     WHEN 75 THEN CASE @Genero WHEN 'M' THEN 'Harold Martín' ELSE 'Carmen Rosa' END
                                     WHEN 76 THEN CASE @Genero WHEN 'M' THEN 'Eder Jesús' ELSE 'Luz Marina' END
                                     WHEN 77 THEN CASE @Genero WHEN 'M' THEN 'Roy Jesús' ELSE 'Mercedes del Pilar' END
                                     WHEN 78
                                     ...
                                     WHEN 82 THEN CASE @Genero WHEN 'M' THEN 'Aníbal César' ELSE 'Teresa de Jesús' END
                                     WHEN 83 THEN CASE @Genero WHEN 'M' THEN 'Néstor Hugo' ELSE 'Julia Mercedes' END
                                     WHEN 84 THEN CASE @Genero WHEN 'M' THEN 'Efraín Moisés' ELSE 'Lorena del Pilar' END
                                     WHEN 85 THEN CASE @Genero WHEN 'M' THEN 'Darío Alberto' ELSE 'Yolanda Patricia' END
                                     WHEN 86 THEN CASE @Genero WHEN 'M' THEN 'Rómulo Augusto' ELSE 'Zully Marisol' END
                                     WHEN 87
                                         THEN CASE @Genero WHEN 'M' THEN 'Claudio Enrique' ELSE 'Marleny del Carmen' END
                                     WHEN 88 THEN CASE @Genero WHEN 'M' THEN 'Lisandro David' ELSE 'Yudith Vanessa' END
                                     WHEN 89 THEN CASE @Genero WHEN 'M' THEN 'Yuri Alexander' ELSE 'Noelia Fernanda' END
                                     WHEN 90
                                         THEN CASE @Genero WHEN 'M' THEN 'Giancarlo Paolo' ELSE 'Ximena Alessandra' END
                                     WHEN 91 THEN CASE @Genero WHEN 'M' THEN 'Maicol Stiven' ELSE 'Brithany Nicol' END
                                     WHEN 92 THEN CASE @Genero WHEN 'M' THEN 'Jampier Jesús' ELSE 'Shalom Milagros' END
                                     WHEN 93
                                         THEN CASE @Genero WHEN 'M' THEN 'Keyser Fabricio' ELSE 'Naara Valentina' END
                                     WHEN 94 THEN CASE @Genero WHEN 'M' THEN 'Axel Jostin' ELSE 'Alisson Camila' END
                                     WHEN 95 THEN CASE @Genero WHEN 'M' THEN 'Mathias André' ELSE 'Samantha Nicole' END
                                     WHEN 96 THEN CASE @Genero WHEN 'M' THEN 'Samuel Isaac' ELSE 'Abigail Sofía' END
                                     WHEN 97 THEN CASE @Genero WHEN 'M' THEN 'Elías Josué' ELSE 'Regina Fátima' END
                                     WHEN 98 THEN CASE @Genero WHEN 'M' THEN 'Aaron Gabriel' ELSE 'Salomé Victoria' END
                                     WHEN 99 THEN CASE @Genero WHEN 'M' THEN 'Leónidas David' ELSE 'Danna Isabella' END
                                     WHEN 100
                                         THEN CASE @Genero WHEN 'M' THEN 'Alexander Jesús' ELSE 'María Alejandra' END
                                     WHEN 101 THEN CASE @Genero WHEN 'M' THEN 'José Antonio' ELSE 'Rosa Angélica' END
                                     WHEN 102 THEN CASE @Genero WHEN 'M' THEN 'Luis Alberto' ELSE 'Carmen Luz' END
                                     WHEN 103 THEN CASE @Genero WHEN 'M' THEN 'Pedro Pablo' ELSE 'Ana María' END
                                     WHEN 104 THEN CASE @Genero WHEN 'M' THEN 'Carlos Alberto' ELSE 'María Luisa' END
                                     WHEN 105
                                     ...
                                     WHEN 107 THEN CASE @Genero WHEN 'M' THEN 'Jesús María' ELSE 'Gloria Esther' END
                                     WHEN 108
                                         THEN CASE @Genero WHEN 'M' THEN 'Roberto Carlos' ELSE 'Susana Mercedes' END
                                     WHEN 109 THEN CASE @Genero WHEN 'M' THEN 'William Andrés' ELSE 'Julia Marisol' END
                                     WHEN 110 THEN CASE @Genero WHEN 'M' THEN 'Jhon Fredy' ELSE 'María Isabel' END
                                     WHEN 111
                                         THEN CASE @Genero WHEN 'M' THEN 'Fredy Alexander' ELSE 'Lucila del Rosario' END
                                     WHEN 112 THEN CASE @Genero WHEN 'M' THEN 'Henry Junior' ELSE 'Yolanda Rosario' END
                                     WHEN 113 THEN CASE @Genero WHEN 'M' THEN 'Víctor Raúl' ELSE 'Nancy Elizabeth' END
                                     WHEN 114
                                     ...
                                     WHEN 116 THEN CASE @Genero WHEN 'M' THEN 'César Martín' ELSE 'Liliana Patricia' END
                                     WHEN 117
                                     ...
                                     WHEN 119 THEN CASE @Genero WHEN 'M' THEN 'Ronaldo Jesús' ELSE 'María Antonieta' END
                                     WHEN 120
                                     ...
                                     WHEN 122 THEN CASE @Genero WHEN 'M' THEN 'Brayan Smith' ELSE 'Jhoselyn Natali' END
                                     WHEN 123
                                         THEN CASE @Genero WHEN 'M' THEN 'Stalin Mauricio' ELSE 'María Fernanda' END
                                     WHEN 124 THEN CASE @Genero WHEN 'M' THEN 'Julián Andrés' ELSE 'Valeria Sofía' END
                                     WHEN 125 THEN CASE @Genero WHEN 'M' THEN 'Santiago José' ELSE 'Camila Isabella' END
                                     WHEN 126
                                     ...
                                     WHEN 130 THEN CASE @Genero WHEN 'M' THEN 'Alejandro David' ELSE 'Martina Lucía' END
                                     WHEN 131
                                         THEN CASE @Genero WHEN 'M' THEN 'Diego Fernando' ELSE 'Florencia Milagros' END
                                     WHEN 132 THEN CASE @Genero WHEN 'M' THEN 'Felipe Ignacio' ELSE 'Luciana Paz' END
                                     WHEN 133
                                         THEN CASE @Genero WHEN 'M' THEN 'Tomás Benjamín' ELSE 'Antonella Belén' END
                                     WHEN 134 THEN CASE @Genero WHEN 'M' THEN 'Joaquín Andrés' ELSE 'Delfina Sofía' END
                                     WHEN 135
                                     ...
                                     WHEN 139 THEN CASE @Genero WHEN 'M' THEN 'Valentín José' ELSE 'Olivia Regina' END
                                     WHEN 140
                                         THEN CASE @Genero WHEN 'M' THEN 'Renzo Fabricio' ELSE 'Amelia Guadalupe' END
                                     WHEN 141 THEN CASE @Genero WHEN 'M' THEN 'Jean Paul' ELSE 'Zoe Victoria' END
                                     WHEN 142 THEN CASE @Genero WHEN 'M' THEN 'Cristhian Paul' ELSE 'Luna Isabella' END
                                     WHEN 143 THEN CASE @Genero WHEN 'M' THEN 'Jampier Jesús' ELSE 'Mía Alessandra' END
                                     WHEN 144 THEN CASE @Genero WHEN 'M' THEN 'Yeferson Luis' ELSE 'Aurora Celeste' END
                                     WHEN 145 THEN CASE @Genero WHEN 'M' THEN 'Keyler Stiven' ELSE 'Salomé Victoria' END
                                     WHEN 146 THEN CASE @Genero WHEN 'M' THEN 'Axel Mauricio' ELSE 'Danna Sofía' END
                                     WHEN 147 THEN CASE @Genero WHEN 'M' THEN 'Mathias André' ELSE 'Regina Fátima' END
                                     WHEN 148 THEN CASE @Genero WHEN 'M' THEN 'Samuel Isaac' ELSE 'Naomi Scarlett' END
                                     WHEN 149 THEN CASE @Genero WHEN 'M' THEN 'Elías Josué' ELSE 'Luana Fernanda' END
                                     WHEN 150 THEN CASE @Genero WHEN 'M' THEN 'Aaron Gabriel' ELSE 'Ashley Nicol' END
                                     WHEN 151
                                         THEN CASE @Genero WHEN 'M' THEN 'Leónidas David' ELSE 'Shalom Milagros' END
                                     WHEN 152 THEN CASE @Genero WHEN 'M' THEN 'Jhosep Andrés' ELSE 'Naara Valentina' END
                                     WHEN 153 THEN CASE @Genero WHEN 'M' THEN 'Brayan Jesús' ELSE 'Alisson Camila' END
                                     WHEN 154
                                         THEN CASE @Genero WHEN 'M' THEN 'Stiven Alexander' ELSE 'Samantha Nicole' END
                                     WHEN 155 THEN CASE @Genero WHEN 'M' THEN 'Junior Alexis' ELSE 'Abigail Sofía' END
                                     WHEN 156 THEN CASE @Genero
                                                       WHEN 'M' THEN 'Yampier Fabricio'
                                                       ELSE 'Fabiola del Rosario' END
                                     WHEN 157 THEN CASE @Genero WHEN 'M' THEN 'Maicol Jesús' ELSE 'María Pía' END
                                     WHEN 158 THEN CASE @Genero WHEN 'M' THEN 'Jair Alejandro' ELSE 'María José' END
                                     WHEN 159 THEN CASE @Genero WHEN 'M' THEN 'Yair Stiven' ELSE 'María Fe' END
                                     WHEN 160
                                         THEN CASE @Genero WHEN 'M' THEN 'Jostin Smith' ELSE 'María Auxiliadora' END
                                     WHEN 161 THEN CASE @Genero WHEN 'M' THEN 'Jean Marco' ELSE 'Rosa María' END
                                     WHEN 162 THEN CASE @Genero WHEN 'M' THEN 'Luis Fernando' ELSE 'Carmen Rosa' END
                                     WHEN 163 THEN CASE @Genero WHEN 'M' THEN 'Carlos Miguel' ELSE 'Luz Marina' END
                                     WHEN 164
                                     ...
                                     WHEN 167 THEN CASE @Genero WHEN 'M' THEN 'Raúl Alberto' ELSE 'Inés del Rosario' END
                                     WHEN 168 THEN CASE @Genero WHEN 'M' THEN 'Víctor Hugo' ELSE 'Susana Elizabeth' END
                                     WHEN 169 THEN CASE @Genero WHEN 'M' THEN 'Oscar Iván' ELSE 'Teresa de Jesús' END
                                     WHEN 170 THEN CASE @Genero WHEN 'M' THEN 'Edison Paul' ELSE 'Julia Mercedes' END
                                     WHEN 171 THEN CASE @Genero WHEN 'M' THEN 'Wilmer Jesús' ELSE 'Lorena del Pilar' END
                                     WHEN 172
                                         THEN CASE @Genero WHEN 'M' THEN 'Yony Alexander' ELSE 'Yolanda Patricia' END
                                     WHEN 173 THEN CASE @Genero WHEN 'M' THEN 'Roy Stiven' ELSE 'Zully Marisol' END
                                     WHEN 174
                                     ...
                                     WHEN 176 THEN CASE @Genero WHEN 'M' THEN 'Teófilo Jesús' ELSE 'Noelia Fernanda' END
                                     WHEN 177
                                         THEN CASE @Genero WHEN 'M' THEN 'Fortunato David' ELSE 'Ximena Alessandra' END
                                     WHEN 178 THEN CASE @Genero WHEN 'M' THEN 'Aníbal Moisés' ELSE 'Brithany Nicol' END
                                     WHEN 179 THEN CASE @Genero WHEN 'M' THEN 'Néstor Fabián' ELSE 'Kiara Valentina' END
                                     WHEN 180 THEN CASE @Genero WHEN 'M' THEN 'Efraín Josué' ELSE 'Naomi Scarlett' END
                                     WHEN 181 THEN CASE @Genero WHEN 'M' THEN 'Darío Isaac' ELSE 'Luana Fernanda' END
                                     WHEN 182 THEN CASE @Genero WHEN 'M' THEN 'Rómulo César' ELSE 'Ashley Nicol' END
                                     WHEN 183
                                         THEN CASE @Genero WHEN 'M' THEN 'Claudio Martín' ELSE 'Fabiola del Rosario' END
                                     WHEN 184 THEN CASE @Genero WHEN 'M' THEN 'Lisandro José' ELSE 'María Pía' END
                                     WHEN 185 THEN CASE @Genero WHEN 'M' THEN 'Yuri Stiven' ELSE 'María José' END
                                     WHEN 186 THEN CASE @Genero WHEN 'M' THEN 'Giancarlo Jesús' ELSE 'María Fe' END
                                     WHEN 187
                                         THEN CASE @Genero WHEN 'M' THEN 'Maicol Fabricio' ELSE 'María Auxiliadora' END
                                     WHEN 188 THEN CASE @Genero WHEN 'M' THEN 'Jampier Luis' ELSE 'Rosa María' END
                                     WHEN 189 THEN CASE @Genero WHEN 'M' THEN 'Keyser Alexander' ELSE 'Carmen Rosa' END
                                     WHEN 190 THEN CASE @Genero WHEN 'M' THEN 'Axel Stiven' ELSE 'Luz Marina' END
                                     WHEN 191
                                     ...
                                     WHEN 194 THEN CASE @Genero WHEN 'M' THEN 'Aaron Stiven' ELSE 'Inés del Rosario' END
                                     WHEN 195
                                     ...
                                     WHEN 198 THEN CASE @Genero WHEN 'M' THEN 'Stiven Jesús' ELSE 'Lorena del Pilar' END
                                     WHEN 199
                                     ...
                                     WHEN 202 THEN CASE @Genero WHEN 'M' THEN 'Jair Jesús' ELSE 'Yudith Vanessa' END
                                     WHEN 203 THEN CASE @Genero WHEN 'M' THEN 'Yair Fabricio' ELSE 'Noelia Fernanda' END
                                     WHEN 204
                                         THEN CASE @Genero WHEN 'M' THEN 'Jostin Alexander' ELSE 'Ximena Alessandra' END
                                     WHEN 205 THEN CASE @Genero WHEN 'M' THEN 'Jean Carlos' ELSE 'Brithany Nicol' END
                                     WHEN 206 THEN CASE @Genero WHEN 'M' THEN 'Luis Miguel' ELSE 'Kiara Valentina' END
                                     WHEN 207 THEN CASE @Genero WHEN 'M' THEN 'Carlos Eduardo' ELSE 'Naomi Scarlett' END
                                     WHEN 208 THEN CASE @Genero WHEN 'M' THEN 'Pedro José' ELSE 'Luana Fernanda' END
                                     WHEN 209 THEN CASE @Genero WHEN 'M' THEN 'José David' ELSE 'Ashley Nicol' END
                                     WHEN 210 THEN CASE @Genero WHEN 'M' THEN 'Juan Pablo' ELSE 'Shalom Milagros' END
                                     WHEN 211 THEN CASE @Genero WHEN 'M' THEN 'Raúl Enrique' ELSE 'Naara Valentina' END
                                     WHEN 212 THEN CASE @Genero WHEN 'M' THEN 'Víctor Daniel' ELSE 'Alisson Camila' END
                                     WHEN 213
                                         THEN CASE @Genero WHEN 'M' THEN 'Oscar Mauricio' ELSE 'Samantha Nicole' END
                                     WHEN 214 THEN CASE @Genero WHEN 'M' THEN 'Edison Fabricio' ELSE 'Abigail Sofía' END
                                     WHEN 215
                                         THEN CASE @Genero WHEN 'M' THEN 'Wilmer Alexander' ELSE 'Regina Fátima' END
                                     WHEN 216 THEN CASE @Genero WHEN 'M' THEN 'Yony Jesús' ELSE 'Salomé Victoria' END
                                     WHEN 217 THEN CASE @Genero WHEN 'M' THEN 'Roy Mauricio' ELSE 'Danna Isabella' END
                                     WHEN 218 THEN CASE @Genero WHEN 'M' THEN 'Elvis Alexander' ELSE 'Valeria Paz' END
                                     WHEN 219 THEN CASE @Genero WHEN 'M' THEN 'Segundo Jesús' ELSE 'Martina Belén' END
                                     WHEN 220
                                     ...
                                     WHEN 225 THEN CASE @Genero WHEN 'M' THEN 'Darío Jesús' ELSE 'Delfina Milagros' END
                                     WHEN 226
                                     ...
                                     WHEN 228 THEN CASE @Genero WHEN 'M' THEN 'Lisandro Jesús' ELSE 'Yadira Marisol' END
                                     WHEN 229
                                     ...
                                     WHEN 233 THEN CASE @Genero WHEN 'M' THEN 'Keyser Jesús' ELSE 'Naomi Scarlett' END
                                     WHEN 234 THEN CASE @Genero WHEN 'M' THEN 'Axel Fabricio' ELSE 'Luana Fernanda' END
                                     WHEN 235
                                     ...
                                     WHEN 237 THEN CASE @Genero WHEN 'M' THEN 'Elías Mauricio' ELSE 'María Pía' END
                                     WHEN 238 THEN CASE @Genero WHEN 'M' THEN 'Aaron Fabricio' ELSE 'María José' END
                                     WHEN 239 THEN CASE @Genero WHEN 'M' THEN 'Leónidas Alexander' ELSE 'María Fe' END
                                     WHEN 240
                                         THEN CASE @Genero WHEN 'M' THEN 'Jhosep Jesús' ELSE 'María Auxiliadora' END
                                     WHEN 241 THEN CASE @Genero WHEN 'M' THEN 'Brayan Fabricio' ELSE 'Rosa María' END
                                     WHEN 242 THEN CASE @Genero WHEN 'M' THEN 'Stiven Mauricio' ELSE 'Carmen Rosa' END
                                     WHEN 243 THEN CASE @Genero WHEN 'M' THEN 'Junior Jesús' ELSE 'Luz Marina' END
                                     WHEN 244
                                     ...
                                     WHEN 248 THEN CASE @Genero WHEN 'M' THEN 'Jostin Jesús' ELSE 'Susana Elizabeth' END
                                     WHEN 249 THEN CASE @Genero WHEN 'M' THEN 'Jean Pierre' ELSE 'Teresa de Jesús' END
                                     WHEN 250
                                     ...
                                     WHEN 255 THEN CASE @Genero WHEN 'M' THEN 'Naomi Scarlett' ELSE 'Luana Fernanda' END
                                     WHEN 256 THEN CASE @Genero WHEN 'M' THEN 'Ashley Nicol' ELSE 'Shalom Milagros' END
                                     WHEN 257
                                         THEN CASE @Genero WHEN 'M' THEN 'Fabiola del Rosario' ELSE 'Naara Valentina' END
                                     WHEN 258 THEN CASE @Genero WHEN 'M' THEN 'María Pía' ELSE 'Alisson Camila' END
                                     WHEN 259 THEN CASE @Genero WHEN 'M' THEN 'María José' ELSE 'Samantha Nicole' END
                                     WHEN 260 THEN CASE @Genero WHEN 'M' THEN 'María Fe' ELSE 'Abigail Sofía' END
                                     WHEN 261
                                         THEN CASE @Genero WHEN 'M' THEN 'María Auxiliadora' ELSE 'Regina Fátima' END
                                     WHEN 262 THEN CASE @Genero WHEN 'M' THEN 'Rosa María' ELSE 'Salomé Victoria' END
                                     WHEN 263 THEN CASE @Genero WHEN 'M' THEN 'Carmen Rosa' ELSE 'Danna Isabella' END
                                     WHEN 264 THEN CASE @Genero WHEN 'M' THEN 'Luz Marina' ELSE 'Valeria Paz' END
                                     WHEN 265
                                     ...
                                     WHEN 274 THEN CASE @Genero WHEN 'M' THEN 'Zully Marisol' ELSE 'Yadira Marisol' END
                                     ...
                                     WHEN 279 THEN CASE @Genero WHEN 'M' THEN 'Brithany Nicol' ELSE 'Lesly Giuliana' END
                                     ...
                                     WHEN 283 THEN CASE @Genero WHEN 'M' THEN 'Ashley Nicol' ELSE 'Fátima del Rocío' END
                                     WHEN 284
                                     ...
                                     WHEN 288 THEN CASE @Genero WHEN 'M' THEN 'Abigail Sofía' ELSE 'Rosa Elena' END
                                     WHEN 289 THEN CASE @Genero WHEN 'M' THEN 'Regina Fátima' ELSE 'Gloria Mercedes' END
                                     ...
                                     WHEN 292 THEN CASE @Genero WHEN 'M' THEN 'Valeria Paz' ELSE 'Clara Inés' END
                                     WHEN 293 THEN CASE @Genero WHEN 'M' THEN 'Martina Belén' ELSE 'Silvia Roxana' END
                                     WHEN 294
                                     ...
                                     WHEN 298 THEN CASE @Genero WHEN 'M' THEN 'Luciana Abigail' ELSE 'Renata Sofía' END
                                     WHEN 299
